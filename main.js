...
document.getElementById("drawing_drawn").innerHTML="sketch to be Drawn:-"+sketch;
timer_counter=0;
timer_check="";
drawn_sketch="";
answer_holder="";
...
function draw(){
 ...
 answer_holder="set";
 score++;
 document.getElementById("span-1").innerHTML="Score:"+score;   
    }
}

function check_sketch(){
    timer_counter++;
    document.getElementById("span-2").innerHTML="Timer:-"+timer_counter;
...
function gotResult(error,result){
    if(error){
        ...
        document.getElementById("your_sketch").innerHTML="Your Sketch:"+result[0].label;
